...
*/
        ...
        if ( ! globalMenuEnv.isEmpty() ) {
            qCritical("UBUNTU_MENUPROXY is set, waiting for global menu to appear on D-Bus...");
            ...
            while(true) {
                ...
                if(deadline.hasExpired()){
                    QMessageBox::warning(nullptr, " ", "com.canonical.AppMenu.Registrar did not appear in time on D-Bus.\nContinuing without global menu.");
                    break;
                }
            }
        }
